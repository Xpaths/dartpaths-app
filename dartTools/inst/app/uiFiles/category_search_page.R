category_search_page <- div(
		
		htmlTemplate("templates/category-search.html",
				
				category_search = conditionalPanel(condition="!$('html').hasClass('shiny-busy')", 
													id = "categoryContainer",
													
												
						tags$div(class = "page-title", 
								tags$h2("Search results for ",
										textOutput(outputId = "categoryInputValue")
								)),
						uiOutput("category_helptext"),
						tags$div(dataTableOutput("category_searchResult"))
				),
				
		
				loading_category_page = conditionalPanel(condition="(input.category_searchResult_rows_selected && ($('html').hasClass('shiny-busy')))",
														id = "loadingContainerCat",
						tags$div(class = "content subst-info-content",
								tags$div(class = "col-sm-3", id = "cat-name-loading"),
								tabsetPanel(id = "tabs-loading-cat",
										# B1. Tox Summary
										tabPanel(value = "tab1", title = "Overview", 
												...
												fluidRow(
														column(3, class = "sidebar-overview-loading",	
																...
																tags$div(id = "mam-overview-cat", class = "info-sidebar-title", style = "margin-bottom:15px;", 
																		"Mammalian phenotypes"),
																tags$div(class = "overview-table", 
																...
																tags$div(id = "nonmam-overview-cat", class = "info-sidebar-title", style = "margin-bottom:15px;", 
																		"Non-mammalian phenotypes"),
																tags$div(class = "overview-table", 
																...
																tags$div(class = "overview-line"),
																#In vitro tests
																tags$div(id = "invitro-overview-cat", class = "info-sidebar-title", style = "margin-bottom:15px;", 
																		"In vitro hits"),
														...
														column(5, id = "pathway-overview-loading-cat",
																tags$h2(class = "table-title", "Predicted affected pathways in humans"),
																tags$div(class = "dropdown-filter-wrapper",
																		tags$div(class = "select-evidence", selectInput("selectColLoading", "", c(
																		...
																		tags$div(class = "filter-wrapper",
																				tags$button(
																						id = "recalculate_btn_cat_loading", 
														...
														column(4, id = "pathway-details-loading-cat",
																tags$div(tags$h2(class = "table-title", "Details and evidence for selected pathway")),
																tabsetPanel(id = "pathway-details-tabs-loading-cat",
